    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-screen">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1498654896293-37aacf113fd9?ixlib=rb-4.0.3')"
          }}
        />
        <div className="relative z-20 h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <button className="bg-primary hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full text-lg transition duration-300">
            Make a Reservation
          </button>
        </div>
      </div>
